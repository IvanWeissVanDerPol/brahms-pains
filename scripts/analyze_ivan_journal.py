...
# Topics to extract
DENTISTRY_KEYWORDS = [
    "dentista", "dentist", "dental", "consultorio", "paciente", "pacientes",
    "limpieza", "profilaxis", "implante", "implantes", "corona", "coronas",
    "caries", "restauración", "restauraciones", "operatoria", "endodoncia",
    "cirugía", "maxilar", "oclusal", "periodoncia", "ortodoncia",
    "radiografía", "tac", "cbct", "rayos x",
    "arsenal", "turbina", "micromotor", "compresor",
]

PRICING_KEYWORDS = [
    "precio", "precios", "costo", "costos", "cobrar", "cobro", "cobran",
    "factura", "facturación", "arsenal", "honorario", "honorarios",
    "280 mil", "300 mil", "consulta", "urgencia",
]

WEBSITE_KEYWORDS = [
    "web", "página", "website", "google", "seo", "search engine", "ai search",
    "google maps", "mapa", "redes sociales", "facebook", "instagram", "tiktok",
    "calendly", "agenda", "google calendar", "whatsapp business",
    "5 quick replies", "mensaje", "mensajes",
]

TARGETING_KEYWORDS = [
    "expat", "expats", "expatriate", "expatriota", "expatriotas",
    "gringo", "gringos", "americano", "estadounidense", "inglés", "english",
    "trilingüe", "bilingüe",
]

LOCATION_KEYWORDS = [
    "asunción", "asu", "luque", "burguilla", "fernando", "fernando de la mora",
    "san lorenzo", "lambaré", "capiatá", "itauguá",
]

TIMELINE_KEYWORDS = [
    "julio", "agosto", "septiembre", "octubre", "noviembre", "diciembre",
    "trimestre", "semana", "mes", "fecha",
]
