...
def is_clean(name: str) -> bool:
    ...
    if re.search(r'_[A-Z]_[A-Z]?_?$', name): return False
    return True
...
def main():
    ...
    for tier in ["tier1_deep", "tier2_core", "tier3_extended", "tier4_groups",
                  "untiered_personal", "other_lid", "_dropped", "_conversations"]:
    ...
    out = {
        ...
        "renames": [{"folder": o, "safe_name": n, "jid": j, "source": s, "canonical": c} for o, n, j, s, c in renames],
        "skipped": [{"folder": o, "safe_name": n, "jid": j, "source": s, "reason": r} for o, n, j, s, r in skipped],
    }
