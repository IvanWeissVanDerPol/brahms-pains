# Gaby — Session 2026-08-27 Process File

**Speaker IDs:** Speaker 3 (fragment, 1137–1474s, 28 segs) + Speaker 4 (main voice, 1477–7277s, 300 segs)
**Combined:** 328 segments, 2,518.6s talk-time, 34.6% of session — **the largest talker in the room**
**Archetype:** Primary discloser / late-session processor / hospital patient
**Out:** Gaby first appears at 18:57. Joins the room already mid-process. Closes the session at 02:01:17.

---

## 🎭 What Gaby was working through
...
Gaby's medical reality:
- **Kidney infection** (riñón) — Ale at +1422s: "Una infección de los riñones así re chota. Y Evan estaba yéndose mucho al hospital para acompañarla también."
- Was **internada** multiple times — confirmed at +1399s by Gaby herself
- **Antibiotic + tramadol** at the time of the bed incident (+1626s)
- 22mm **DIU/IUD** placement — painful, large, "no sé si va a estar todo morado, todo rojo" (+4023s)
- **Kidney stone** at +6100s — "estaba flotando ahí un en mi riñón y yo: '¡Aaah!'"
- Doctor's warning at +3863s: "**Estás demasiado estresada. Bajá un cambio o no te vas a poner nunca.**" She's been on this trajectory for almost 4 weeks.
- At +3901s, Gaby corrects the record about who was in the hospital with her — **"no había estado ni Iván, estaba con mi mujer"** — spells out Iván wasn't there when she was hospitalized. (She has a partner — "mi mujer".)
- At +4385s, Gaby processes the **cumulative exhaustion** of always being the caretaker: "**Yo viví toda mi vida cuidándola a mi abuela, a mi hermana, a mi papá, a todo el mundo. Y sé lo que es hospital y no da gusto.**"

### Layer 3: The late-session breakthrough (Act 4, 6871–6915s)

The most important line of the entire session:

> "Inclusive, ni siquiera sabía que tenía **autismo**. Ni siquiera sabía, nunca supe, siempre pensé que estaba **loca**. Sí."

> "En serio, yo hace poco supe. **A mis 45, 45, 44, casi 45 años supe que tenía autismo**, que era algo así. Me hicieron todas esas pruebas rompebolas, pero igual de todas formas, la primera persona que me dijo: 'Vos, Sofita', su mamá."

What comes out:
- Gaby was **almost 45 when diagnosed with autism**
- She'd lived her entire life thinking she was "**loca**" (crazy)
...
> "Porque supuestamente yo le, le drenaba a él, porque yo en realidad estoy enferma, yo estaba internada. Tipo que se iba al hospital, supuestamente yo le drenaba su energía."

Gaby reports that people in her circle **accused her of draining energy** from a man who was visiting her in the hospital. This is **gaslighting by medical-proxy** — she's sick, she's in hospital, she's told she's the burden.
...
Gaby defends **Iván's choice to accompany her to hospital** — says it was genuine, not obligated. This is her **processing the relationship directly**, in the room, with Iván there.

### Layer 6: The "con mi mujer" disclosure (3901s)

> "Estaba con los otros en el hospital, ¿verdad? O sea, no había estado ni Iván, **estaba con mi mujer**."

Gaby has a **female partner**. This is mentioned once, in passing, as a fact-correction about who was in the hospital with her. The group doesn't dwell on it. It is, however, **important structural information** about Gaby's relational context — she's not single, she has a partner, the Iván dynamic is layered on top of that.

---

## 🧬 Themes that surface from Gaby

| Theme | Lines |
|---|---|
| **Caregiver exhaustion** | "Yo viví toda mi vida cuidándola a mi abuela, a mi hermana, a mi papá" — but no one cares for her |
| **Misdiagnosis / misrecognition** | 45 years thinking she was "loca"; autism dx reframes the entire life narrative |
| **Boundary violation in her own space** | The bed incident in *her* bed, *her* house |
| **Conflicted about Iván's passivity** | "Iván no puede decir que no" — admitted by Gaby, not contested by Iván |
| **Defended against the assailant's narrative** | "Mentía, se contradecía, se cambiaba" |
| **Ambivalence about her own victimhood** | Doesn't file the orden de restricción herself; asks Lourdes if she should |
| **The "drena energía" accusation** | The original family wound — being told she's a burden when she's sick |
| **Has a partner ("mi mujer")** | Not centered, not dwelt on, present |

---

## 🔗 Relational map (in this session)

| Person | Gaby's relationship to them in this session |
|---|---|
| **Iván** | Central figure being processed; defended his genuineness; admits his "no puedo decir que no" pattern |
...
If Gaby returns:
1. **Did you file the orden de restricción?** (raised but unanswered)
2. **What's the conversation with your partner about this?** (the relationship layer is silent)
3. **The autism diagnosis** — what does it change for you now? How does it re-narrate the "drena energía" accusation? The "loca" self-label?
4. **The bed incident** — when you say "yo no entendía más ni qué es lo que pasó", what would understanding it look like?

---

*File: `SESSION_2026-08-27_GABY_PROCESS.md`*
