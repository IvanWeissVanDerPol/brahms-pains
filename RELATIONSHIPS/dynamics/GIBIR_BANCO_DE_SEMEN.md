# Gibir Banco De Semen

> **Auto-generated profile stub** (2026-07-23T21:05:23)
> **Source:** vCard phonebook (full export 2026-07-23)
> **JID:** 595984116894
> **Tier:** untiered_personal · **Relationship score:** 43.0 (WARM)
> **Stats:** 114 messages · 2024-06-11 → 2025-04-11
...
Most active: **Wednesday** at **22:00** (evening (18-23))
Top topics: consulta (15), buenas (11), estudios (10), costo (10), gracias (9)
Avg msg length: Ivan 50 chars, them 112 chars
...
**First message** (2024-06-11, Ivan): Buenas  Soy Iván Weiss Van der pol   recién llamé para agendar una cita virtual  Para ver de congelar mi semen   Espero la invitación a la cita /zoom  Muchas gracias 🙂

**Last from Ivan** (2025-04-11): :)

**Last from them** (2025-04-11): Para que pueda indicarle mejor.
...
|--------|-------|
| Total messages | 114 |
| First message | 2024-06-11 |
| Last message | 2025-04-11 |
...
- vCard phonebook (full export, 2026-07-23): name "Gibir Banco De Semen"
...
**Last contact**: 472d ago

### Time Patterns

| Metric | Value | Clinical |
|--------|------:|----------|
| Late-night ratio (22:00-04:00) | 41.2% | ABOVE baseline (32%) |
| Peak hour | 22h | |
| Peak day | Wednesday | |
...
|--------|------:|---------|
| Ivan initiator ratio | 54.4% | Balanced |
| Ivan starts conv | 10 | |
| They start conv | 3 | |
| Ivan initiator % | 76.9% | |
...
- **Above-baseline late-night (41.2%)**: Slightly elevated compared to Ivan's 32% baseline
- **Abandoned (472d)**: Grief signal - over a year silent
