...
> **JID:** 595991737902
> **Tier:** untiered_personal · **Relationship score:** 38.0 (WARM)
> **Stats:** 44 messages · 2025-03-05 → 2025-03-06

## Overview

**Auto-extracted stats** (24 from Ivan, 20 from them, 0 emojis)

Peak months: `2025-03` (44 msgs)
Language mix: es: 9, other: 35
Most active: **Wednesday** at **2:00** (night (23-6))
Top topics: buenas (2), pasas (2), buscar (2), alias (2), local (2)
...
**Last from Ivan** (2025-03-05): En el auto gris

**Last from them** (2025-03-06): _Buenas buenas!_  Estamos listo para recibir tu pedido en nuestro nuevo local sobre (Augusto Roa Bastos casi Antillas)  *Hamburgueson de 30mil con papas fritas Árabe de pollo 2x20mil Árabe mixta 20mil
...
- vCard phonebook (full export, 2026-07-23): name "Lomito"
