...
> **JID:** 595216889000
> **Tier:** untiered_personal · **Relationship score:** 57.6 (ACTIVE)
> **Stats:** 82 messages · 2024-01-15 → 2026-07-01

## Overview

**Auto-extracted stats** (47 from Ivan, 35 from them, 29 emojis)

Peak months: `2024-12` (9 msgs), `2025-03` (10 msgs), `2025-04` (25 msgs)
Language mix: es: 35, other: 47
Most active: **Wednesday** at **19:00** (evening (18-23))
Top topics: cirugia (56), maria (48), infantil (34), pediatrica (29), martinez (28)
...
Mood trend: overall +0.70, recent +0.33, trend Δ -0.67 (-0.67 (cooling))

**They call Ivan:** 'ivan' (4x)

**First message** (2024-01-15, Ivan): Hola

**Last from Ivan** (2026-07-01): Hola

**Last from them** (2026-04-16): Gracias por su respuesta.
...
|--------|-------|
| Total messages | 82 |
| First message | 2024-01-15 |
| Last message | 2026-07-01 |
...
- **[2025-08-20] Them** (2 emojis): 🏨Muchas gracias  por comunicarse con el Centro Medico Bautista. 🗓️Su cita es para el día: *MIERCOLES* 20-AUG-25 18:15Hs🩺WILMA BORDON BOVEDA
- **[2025-10-10] Them** (2 emojis): 🏨Muchas gracias  por comunicarse con el Centro Medico Bautista. 🗓️Su cita es para el día: *MIERCOLES* 15-OCT-25 19:00Hs🩺WILMA BORDON BOVEDA
- **[2025-04-17] Them** (2 emojis): 🏨Muchas gracias  por comunicarse con el Centro Medico Bautista. 🗓️Su cita es para el día: *LUNES* 21-APR-25 09:45Hs🩺GUSTAVO GIMENEZ LOPEZ
...
- vCard phonebook (full export, 2026-07-23): name "Hospital Bautista"
...
**Chats analyzed**: 1
**Tier(s)**: tier2_core
**Last contact**: 26d ago

### Time Patterns

| Metric | Value | Clinical |
|--------|------:|----------|
| Late-night ratio (22:00-04:00) | 28.0% | baseline |
| Peak hour | 19h | |
| Peak day | Wednesday | |
...
|--------|------:|---------|
| Ivan initiator ratio | 57.3% | Balanced |
| Ivan starts conv | 19 | |
| They start conv | 3 | |
| Ivan initiator % | 86.4% | |
