...
> **JID:** 595983523251
> **Tier:** tier3_extended · **Relationship score:** 53.4 (ACTIVE)
> **Stats:** 366 messages · 2021-11-16 → 2026-06-16
...
- vCard phonebook (full export, 2026-07-23): name "Nathaly Schinini"
...
**Chats analyzed**: 1
**Tier(s)**: tier2_core
**Last contact**: 41d ago

### Time Patterns

| Metric | Value | Clinical |
|--------|------:|----------|
| Late-night ratio (22:00-04:00) | 39.6% | baseline |
| Peak hour | 18h | |
| Peak day | Friday | |
...
|--------|------:|---------|
| Ivan initiator ratio | 57.9% | Balanced |
| Ivan starts conv | 36 | |
| They start conv | 12 | |
| Ivan initiator % | 75.0% | |
...
- **Above-baseline late-night (39.6%)**: Slightly elevated compared to Ivan's 32% baseline
