...
> **JID:** 595976569739
> **Tier:** tier2_core · **Relationship score:** 67.4 (CLOSE)
> **Stats:** 1,128 messages · 2022-12-21 → 2026-07-16

## Overview

**Auto-extracted stats** (609 from Ivan, 519 from them, 83 emojis)

Peak months: `2025-07` (89 msgs), `2025-10` (88 msgs), `2026-04` (114 msgs)
Language mix: other: 791, es: 305, en: 21, mixed: 11
Most active: **Saturday** at **16:00** (evening (18-23))
Top topics: google (40), https (38), estoy (30), tengo (28), hacer (23)
...
Audio usage: 4.2% of all messages are voice notes
Sentiment: Ivan +0.48 (very positive) (pos 20 / neg 7), them +1.00 (very positive) (pos 10 / neg 0)
Mood trend: overall +0.23, recent +0.52, trend Δ +0.25 (+0.25 (warming))

**Ivan calls them:** 'amor' (1x), 'loco' (1x), 'mama' (1x), 'kiki' (1x)

**They call Ivan:** 'ivan' (4x)

**First message** (2022-12-21, Ivan): Holis  Puedo pasar a la sexshop?  Quiero comprar 1 plug de zorro  1 vela de masaje  Y 2 vibradores

**Last from Ivan** (2026-07-16): hello si en tus viajes ves juguetes con control remoto me interesa uno para cola que se explanda y vibre con cockring y uno remoto para chicas jasjajs

**Last from them** (2026-07-14): 😂

## Communication stats

| Metric | Value |
|--------|-------|
| Total messages | 1,128 |
| First message | 2022-12-21 |
| Last message | 2026-07-16 |
...
- **[2026-04-03] Ivan** (3 emojis): Based on the ROADMAP.md, here's the full breakdown:  FUN4ME STORE — E-commerce para sex shop boutique en Asunción, Paraguay  TARGET: Tienda online en español, Messaging-first, discreta, para adultos 18+  ---  PHASE 0: VALIDACION (Pre-desarrollo) Costo: $0 en desarrollo - Entrevistar 20 clientes reale
...
- **[2026-01-21] Ivan** (6 emojis): hello prepare esto si te parece chill llevo un poco uwuwu  https://www.youtube.com/watch?v=zW6iL6Dez-c&pp=ygUQcmljayBzaW1wc29uIG9pbNIHCQmHCgGHKiGM7w%3D%3D  RSO 101: La navaja suiza de los extractos 🌿  Básicamente, el RSO es un concentrado de espectro completo que ya está "activado". Como no necesita
- **[2026-04-03] Ivan** (3 emojis): Based on the ROADMAP.md, here's the full breakdown:  FUN4ME STORE — E-commerce para sex shop boutique en Asunción, Paraguay  TARGET: Tienda online en español, Messaging-first, discreta, para adultos 18+  ---  PHASE 0: VALIDACION (Pre-desarrollo) Costo: $0 en desarrollo - Entrevistar 20 clientes reale
- **[2026-04-03] Ivan** (0 emojis): Here's the complete client questionnaire:  ---  LISTA DE REQUERIMIENTOS — FUN4ME STORE Todo lo que necesitamos del cliente  ═══════════════════════════════════ 1. IDENTIDAD Y MARCA ═══════════════════════════════════  REQUERIDO: - Logo en alta resolución (PNG transparente + SVG) - Nombre legal de la
...
- vCard phonebook (full export, 2026-07-23): name "Rach"
...
|--------|------:|----------|
| Late-night ratio (22:00-04:00) | 18.6% | below baseline |
| Peak hour | 4h | |
| Peak day | Sunday | |
...
|--------|------:|---------|
| Ivan initiator ratio | 9.4% | They chase Ivan |
| Ivan starts conv | 6 | |
| They start conv | 3 | |
| Ivan initiator % | 66.7% | |
...
- What draws them to initiate most conversations?
