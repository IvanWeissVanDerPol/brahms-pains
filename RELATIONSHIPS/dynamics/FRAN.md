...
> **JID:** 595986805654
> **Tier:** tier2_core · **Relationship score:** 68.7 (CLOSE)
> **Stats:** 7,392 messages · 2021-10-29 → 2026-07-13
...
Most active: **Monday** at **23:00** (afternoon (12-18))
...
**First message** (2021-10-29, Ivan): holis me podes pasar tus respuestas de la actividad de fisica ?

**Last from Ivan** (2026-07-13): te va a ser hot

**Last from them** (2026-06-25): Ja u

## Communication stats

| Metric | Value |
|--------|-------|
| Total messages | 7,392 |
| First message | 2021-10-29 |
| Last message | 2026-07-13 |
...
- vCard phonebook (full export, 2026-07-23): name "Fran"
...
|--------|------:|----------|
| Late-night ratio (22:00-04:00) | 36.0% | baseline |
| Peak hour | 23h | |
| Peak day | Monday | |
...
|--------|------:|---------|
| Ivan initiator ratio | 47.2% | Balanced |
| Ivan starts conv | 251 | |
| They start conv | 220 | |
| Ivan initiator % | 53.3% | |
...
| Metric | Value |
|--------|------:|
| Max streak (consecutive days) | 12d |
| Avg voice % | 9.5% |
