...
> **JID:** 595985249907
> **Tier:** tier2_core · **Relationship score:** 64.8 (ACTIVE)
> **Stats:** 2,399 messages · 2025-05-05 → 2026-07-05

## Overview

**Auto-extracted stats** (1,283 from Ivan, 1,116 from them, 37 emojis)
...
| Metric | Value |
|--------|-------|
| Total messages | 2,399 |
| First message | 2025-05-05 |
...
- **[2025-11-30] Them** (2 emojis): Es Maga mi perrita, se quedo en lo de mis padres y ahora le veo cuando voy de visita 😭❤️
- **[2026-01-22] Ivan** (2 emojis): Se hacen más comisiones   Ahora ale tiene que hacer su fursona jsjsja  🧠🧠 Jajajaj
- **[2025-11-12] Ivan** (0 emojis): una vez que este mas pro la empresa  def vamos a tener gente en el area de hacer videos IA   para nosotros para ofrecer de adds para contenido de youtube para material de cursos para material de cursos de clientes  peliculas y trailers IA para guionistas en usa(mi tio)    mira un fla si no hay algun
- **[2025-12-05] Ivan** (0 emojis): Lit pollos + condimentos random que te estiren   Sal pimienta pimentón dulce mostaza miel romero manteca (?  Anything random lgmt jajajaja    Y anything que quieras mezclar para el relleno de las empanadas después    Puré de tomate con pollo  O más queso   Cebolla con calabaza y pollo?  Lo que te es
- **[2026-01-22] Ivan** (0 emojis): ## 5. Cognitive Patterns  1. **Do you have recurring thoughts or mental loops that are hard to stop?** Pre-answer: i dont think so 2. **Do you tend toward perfectionism in any areas?** Pre-answer:i dont think so nothink is perfect but def ill give my best effort allways and research how to do it the
...
- vCard phonebook (full export, 2026-07-23): name "Adri 🌸"
...
|--------|------:|----------|
| Late-night ratio (22:00-04:00) | 35.7% | baseline |
| Peak hour | 19h | |
| Peak day | Saturday | |
...
|--------|------:|---------|
| Ivan initiator ratio | 54.2% | Balanced |
| Ivan starts conv | 80 | |
| They start conv | 71 | |
| Ivan initiator % | 53.0% | |
...
- **Above-baseline late-night (35.7%)**: Slightly elevated compared to Ivan's 32% baseline
