...
> **JID:** 595971190089
> **Tier:** untiered_personal · **Relationship score:** 51.5 (ACTIVE)
> **Stats:** 52 messages · 2024-01-04 → 2024-10-25
...
Most active: **Saturday** at **20:00** (evening (18-23))
Top topics: https (13), youtube (4), referral (3), revolut (2), compa (2)
Avg msg length: Ivan 26 chars, them 48 chars
...
**Last from Ivan** (2024-09-23): Gracias

**Last from them** (2024-10-25): https://www.youtube.com/watch?v=9Aoh1JF6QT4
...
|--------|-------|
| Total messages | 52 |
| First message | 2024-01-04 |
| Last message | 2024-10-25 |
...
- vCard phonebook (full export, 2026-07-23): name "Jose S"
...
**Chats analyzed**: 1
**Tier(s)**: tier2_core
**Last contact**: 640d ago

### Time Patterns

| Metric | Value | Clinical |
|--------|------:|----------|
| Late-night ratio (22:00-04:00) | 9.6% | below baseline |
| Peak hour | 20h | |
| Peak day | Saturday | |
...
|--------|------:|---------|
| Ivan initiator ratio | 42.3% | Balanced |
| Ivan starts conv | 2 | |
| They start conv | 9 | |
| Ivan initiator % | 18.2% | |
...
- **Abandoned (640d)**: Grief signal - over a year silent
- **Voice-heavy (15.4%)**: Voice is primary modality
