...
> **JID:** 595986186281
> **Tier:** tier3_extended · **Relationship score:** 51.7 (ACTIVE)
> **Stats:** 467 messages · 2021-11-05 → 2025-07-11

## Overview

**Auto-extracted stats** (222 from Ivan, 245 from them, 9 emojis)

Peak months: `2021-12` (31 msgs), `2022-10` (57 msgs), `2023-11` (124 msgs)
Language mix: es: 189, other: 276, mixed: 1, en: 1
Most active: **Tuesday** at **19:00** (evening (18-23))
Top topics: gracias (22), ahora (22), estoy (22), hacer (14), nomas (13)
Avg msg length: Ivan 23 chars, them 46 chars
Avg reply time: Ivan 22m, them 16m
Question ratio: Ivan 8.1%, them 9.0%
Longest streak: **4** consecutive days · Longest gap: **231** days
Audio usage: 4.3% of all messages are voice notes
Sentiment: Ivan +1.00 (very positive) (pos 9 / neg 0), them +0.67 (very positive) (pos 25 / neg 5)
Mood trend: overall +0.62, recent +0.48, trend Δ -0.45 (-0.45 (cooling))

**They call Ivan:** 'ivan' (1x)

**First message** (2021-11-05, Them): Hola Weiss, una consulta, por si acaso vos no tenes pdf o drive de física 2? Onda lo que solemos hacer de la revisión y eso?

**Last from Ivan** (2025-07-11): Jauu  Muchas gracias:))

**Last from them** (2025-07-11): Pero las veces que lleve en compulandia y nissei no siempre me solucionaron unu jaja pero por cualquier cosa como segunda opción lleva a Nissei mbae
...
- **[2021-11-05] Them** (0 emojis): Hola Weiss, una consulta, por si acaso vos no tenes pdf o drive de física 2? Onda lo que solemos hacer de la revisión y eso?
...
- vCard phonebook (full export, 2026-07-23): name "Marco Poli"
...
**Chats analyzed**: 1
**Tier(s)**: tier2_core
**Last contact**: 381d ago

### Time Patterns

| Metric | Value | Clinical |
|--------|------:|----------|
| Late-night ratio (22:00-04:00) | 23.6% | below baseline |
| Peak hour | 19h | |
| Peak day | Tuesday | |
...
|--------|------:|---------|
| Ivan initiator ratio | 47.5% | Balanced |
| Ivan starts conv | 20 | |
| They start conv | 17 | |
| Ivan initiator % | 54.1% | |
...
- **Abandoned (381d)**: Grief signal - over a year silent
