...
> **JID:** 595993474633
> **Tier:** untiered_personal · **Relationship score:** 46.1 (WARM)
> **Stats:** 63 messages · 2025-10-13 → 2025-12-23

## Overview

**Auto-extracted stats** (17 from Ivan, 46 from them, 1 emojis)

Peak months: `2025-10` (39 msgs), `2025-11` (8 msgs), `2025-12` (16 msgs)
Language mix: other: 46, es: 17
Most active: **Monday** at **5:00** (night (23-6))
Top topics: haces (7), estoy (6), chill (4), https (3), estás (2)
...
Audio usage: 17.5% of all messages are voice notes
...
**Last from Ivan** (2025-12-17): chill jajaja  que disfrutes

**Last from them** (2025-12-23): Estoy creo cerca de tu casa
...
|--------|-------|
| Total messages | 63 |
| First message | 2025-10-13 |
| Last message | 2025-12-23 |
...
- vCard phonebook (full export, 2026-07-23): name "Ogr"
...
**Total messages**: 1,196
**Chats analyzed**: 3
**Tier(s)**: tier3_extended, tier4_groups
...
|--------|------:|----------|
| Late-night ratio (22:00-04:00) | 25.9% | baseline |
| Peak hour | 5h | |
| Peak day | Monday | |
...
|--------|------:|---------|
| Ivan initiator ratio | 1.9% | They chase Ivan |
| Ivan starts conv | 4 | |
| They start conv | 243 | |
| Ivan initiator % | 1.6% | |
...
- **Ivan passive (1.9%)**: They carry most of the relational load
