...
> **JID:** 595982923913
> **Tier:** tier3_extended · **Relationship score:** 54.9 (ACTIVE)
> **Stats:** 217 messages · 2024-01-27 → 2026-02-18
...
Avg msg length: Ivan 37 chars, them 30 chars
...
**Last from Ivan** (2026-02-18): V2

**Last from them** (2026-02-18): Veremos si te escribe jajaja le pasé tu ig
...
- vCard phonebook (full export, 2026-07-23): name "Natalia Cruz"
...
**Chats analyzed**: 1
**Tier(s)**: tier2_core
**Last contact**: 158d ago

### Time Patterns

| Metric | Value | Clinical |
|--------|------:|----------|
| Late-night ratio (22:00-04:00) | 41.5% | ABOVE baseline (32%) |
| Peak hour | 20h | |
| Peak day | Friday | |
...
|--------|------:|---------|
| Ivan initiator ratio | 58.5% | Balanced |
| Ivan starts conv | 18 | |
| They start conv | 5 | |
| Ivan initiator % | 78.3% | |
...
- **Above-baseline late-night (41.5%)**: Slightly elevated compared to Ivan's 32% baseline
