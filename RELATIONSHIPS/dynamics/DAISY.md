...
**Auto-extracted stats** (179 from Ivan, 148 from them, 26 emojis)

Peak months: `2024-04` (33 msgs), `2025-08` (33 msgs), `2025-09` (44 msgs)
Language mix: other: 166, es: 156, en: 2, mixed: 3
Most active: **Friday** at **19:00** (evening (18-23))
Top topics: gracias (18), estoy (15), https (15), hacer (14), proyectos (13)
Avg msg length: Ivan 102 chars, them 41 chars
...
**They call Ivan:** 'ivan' (24x), 'iván' (1x)

**First message** (2024-02-24, Ivan): Acá es donde estoy para contexto n.n

**Last from Ivan** (2026-02-24): ONDA MIS WORK FLOWS SON ASI  Y MIENTRAS HACE COCINO Y HAGO LOS TODOS DE OTROS PROYECTOS JASJAJS

**Last from them** (2026-02-24): Gracias Ivan
...
|--------|-------|
| Total messages | 327 |
| First message | 2024-02-24 |
| Last message | 2026-02-24 |
...
- vCard phonebook (full export, 2026-07-23): name "Daisy"
...
**Total messages**: 327
**Chats analyzed**: 1
**Last contact**: 152d ago

### Time Patterns

| Metric | Value | Clinical |
|--------|------:|----------|
| Late-night ratio (22:00-04:00) | 31.5% | baseline |
| Peak hour | 19h | |
| Peak day | Friday | |
...
|--------|------:|---------|
| Ivan initiator ratio | 54.7% | Balanced |
| Ivan starts conv | 9 | |
| They start conv | 8 | |
| Ivan initiator % | 52.9% | |
